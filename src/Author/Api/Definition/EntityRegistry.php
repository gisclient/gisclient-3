    ...
    public static function getDefinitions()
    {
        return [
            ...
            'style' => [
                ...
                'sortable_fields' => ['style_id', 'style_order', 'style_name'],
                'default_sort' => 'style_order',
                'relationships' => [
                    'class' => [
                        'type' => 'class',
                        'local_key' => 'class_id',
            ...
            'field' => [
                ...
                'sortable_fields' => ['field_id', 'field_order', 'field_name', 'field_header'],
                'default_sort' => 'field_order',
                'relationships' => [
                    'layer' => [
                        'type' => 'layer',
                        'local_key' => 'layer_id',
