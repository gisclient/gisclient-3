...
abstract class AbstractAuthorUser
{
    protected $options;
...
*/
            ...
            if (!isset($this->mapLayers[$row['theme_name']])) {
                $this->mapLayers[$row['theme_name']] = array();
            }
            if (!isset($this->mapLayers[$row['theme_name']][$row['layergroup_name']])) {
                $this->mapLayers[$row['theme_name']][$row['layergroup_name']] = array();
            }
    ...
    {
        if (empty($this->authorizedLayers)) {
