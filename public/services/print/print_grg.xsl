							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell padding="2px">
                                        <fo:block white-space="pre">Scala 1: <xsl:value-of select="map-scale" /></fo:block>
									</fo:table-cell>
                                    <fo:table-cell padding="2px" number-columns-spanned="2">
                                        <fo:block white-space="pre">Box: <xsl:value-of select="map-box" /></fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell padding="2px">
                                        <fo:block>
                                            <xsl:if test="map-date!=''">
                                                <fo:block white-space="pre">Data: <xsl:value-of select="map-date" /></fo:block>
                                            </xsl:if>
                                        </fo:block>
                                    </fo:table-cell>
								</fo:table-row>
