...
define('CLIENT_LOGO', empty(getenv('GC_PRINT_LOGO_SX')) ? null : getenv('GC_PRINT_LOGO_SX')); //LOGO CLIENTE PERSONALIZZATO IN AUTHOR

define('MAPFILE_MAX_SIZE', getenv('MAPFILE_MAX_SIZE') ?: 4096); //MASSIMA DIMENSIONE IN PIXEL DEL MAPFILE. PER STAMPE A0 INSERIRE: 20480
