...
INSERT INTO gisclient_34.symbol (symbol_name, symbolcategory_id, icontype, symbol_image, symbol_def, symbol_type, font_name, ascii_code, filled, points, image) VALUES
    ('VIGNETO', '3', '0', NULL, 'Type VECTOR\n  Filled TRUE\n  Points\n\t\t.8 .6\n\t\t.4 .6\n\t\t.6 0\n\t\t.4 0\n\t\t.2 .6\n\t\t.4 .8\n\t\t.6 .8\n\t\t.8 .6\n  END\n\t\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('TENT', '1', '0', NULL, 'TYPE VECTOR\nFILLED TRUE\nPOINTS\n0 1\n.5 0\n1 1\n.75 1\n.5 .5\n.25 1\n0 1\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('STAR', '1', '0', NULL, 'TYPE VECTOR\nFILLED TRUE\nPOINTS\n0 .375\n.35 .375\n.5 0\n.65 .375\n1 .375\n.75 .625\n.875 1\n.5 .75\n.125 1\n.25 .625\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('TRIANGLE', '1', '0', NULL, 'TYPE VECTOR\nFILLED TRUE\nPOINTS\n0 1\n.5 0\n1 1\n0 1\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('SQUARE', '1', '0', NULL, 'TYPE VECTOR\nFILLED TRUE\nPOINTS\n0 1\n0 0\n1 0\n1 1\n0 1\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('PLUS', '1', '0', NULL, 'TYPE VECTOR\nPOINTS\n.5 0\n.5 1\n-99 -99\n0 .5\n1 .5\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('CROSS', '1', '0', NULL, 'TYPE VECTOR\nPOINTS\n0 0\n1 1\n-99 -99\n0 1\n1 0\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('VIVAIO', '3', '0', NULL, 'TYPE Vector\n  POINTS\n\t\t.3 1\n\t\t.7 1\n\t\t.9 .1\n\t\t.1 .1\n\t\t.3 1\n\t\t-99 -99\n\t\t.2 .2\n\t\t.2 .1\n\t\t-99 -99\n\t\t.5 .2\n\t\t.5 .1\n\t\t-99 -99\n\t\t.7 .2\n\t\t.7 .1\n  END\n\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('CIRCLE', '1', '0', NULL, 'TYPE ELLIPSE\nFILLED TRUE\nPOINTS\n1 1\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('WATER', '3', '0', NULL, 'Type VECTOR\n  Filled FALSE  \n   Points\n\t\t0 .6\n\t\t.1 .4\n\t\t.2 .4\n\t\t.3 .6\n\t\t.4 .6\n\t\t.5 .4\n\t\t.6 .4\n\t\t.7 .6\n\t\t.8 .6\n\t\t.9 .4\n\t\t1 .4\n\t\t1.1 .6\n  END', NULL, NULL, NULL, '0', NULL, NULL),
    ('CIRCLE_EMPTY', '3', '0', NULL, 'TYPE Vector\n  POINTS\n    0 .5\n\t\t.1 .7\n\t\t.3 .9\n\t\t.5 1\n\t\t.7 .9\n\t\t.9 .7\n\t\t1 .5\n\t\t.9 .3\n\t\t.7 .1\n\t\t.5 0\n\t\t.3 .1\n\t\t.1 .3\n\t\t0 .5\n  END\n\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('CIRCLE_HALF', '3', '0', NULL, 'TYPE Vector\n  POINTS\n    0 .5\n\t\t.1 .7\n\t\t.3 .9\n\t\t.5 1\n\t\t.7 .9\n\t\t.9 .7\n\t\t1 .5\n\t\t0 .5\n  END\n\n\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('BOSCO', '3', '0', NULL, 'TYPE Vector\n  POINTS\n    .5 1\n    .5 0\n\t\t-99 -99\n\t\t.5 0\n\t\t.3 .1 \n\t\t-99 -99\n\t\t.5 .0\n\t\t.7 .1\n\t\t-99 -99\n\t\t.5 .3\n\t\t.2 .4\n\t\t-99 -99\n\t\t.5 .3\n\t\t.8 .4\n\t\t-99 -99\n\t\t.5 .6\n\t\t.1 .8\n\t\t-99 -99\n\t\t.5 .6\n\t\t.9 .8\n  END\n\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('CIMITERO', '3', '0', NULL, 'TYPE VECTOR\nPOINTS\n.5 0\n.5 1\n-99 -99\n.2 .3\n.8 .3\nEND\n', NULL, NULL, NULL, '0', NULL, NULL),
    ('FRUTTETO', '3', '0', NULL, 'Type VECTOR\n  Filled TRUE\n  Points\n\t\t.2 1\n\t\t.2 .8\n\t\t.4 .8 \n\t\t.4 .4\n\t\t0 0\n\t\t.2 0\n\t\t.4 .2\n\t\t.4 0\n\t\t.6 0\n\t\t.6 .2\n\t\t.8 0\n\t\t1 0\n\t\t.6 .4\n\t\t.6 .8\n\t\t.8 .8\n\t\t.8 1\n\t\t.2 1\n  END\n\t\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('INCOLTO', '3', '0', NULL, 'Type VECTOR\n  Filled TRUE\n  Points\n\t0 1\n\t.2 .6\n\t.35 .85\n\t.5 .6\n\t.65 .85\n\t.8 .6 \n\t1 1\n\t.9 1\n\t.8 .8\n\t.7 1\n\t.6 1\n\t.5 .8\n\t.4 1\n\t.3 1\n\t.2 .8\n\t.1 1\n\t0 1\n  END\n\t\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('PASCOLO', '3', '0', NULL, '  Type VECTOR\n  Filled TRUE\n  Points\n    0 .4\n\t\t.2 1\n\t\t.4 1\n\t\t.2 .4\n\t\t0 .4\n\t\t-99 -99\n\t\t.4 0\n\t\t.6 0 \n\t\t.6 1\n\t\t.4 1\n\t\t.4 0 \n\t   -99 -99\n\t\t .8 .4\n\t\t 1 .4\n\t\t .8 1\n\t\t .6 1\n\t\t .8 .4\t\n  END\n\t\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('RANDOM', '3', '0', NULL, '  Type VECTOR\n  Filled TRUE\n  Points\n    .1 .1\n\t\t.3 .3\n  -99 -99\n\t\t.5 .2\n\t\t.7 0\n  -99 -99\n\t\t.9 .2\n  -99 -99\n\t\t.7 .3\n  -99 -99\n\t\t.1 .5\t\t\n  -99 -99\n\t\t.6 .5\n\t\t.4 .7\n  -99 -99\n\t\t.3 .8\n  -99 -99\n\t\t.8 .7\n  -99 -99\n\t\t.1 .9\n  -99 -99\n\t\t.6 .8\n\t\t.6 1\n  END\n\t\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('RISAIA', '3', '0', NULL, 'Type VECTOR\n  Filled TRUE\n  Points\n\t\t0 1\n\t\t0 .4\n\t\t.2 .4\n\t\t.2 1\n\t\t0 1\n\t\t-99 -99\n\t\t.4 1\n\t\t.4 0\n\t\t.6 0\n\t\t.6 1\n\t\t.4 1\n\t\t-99 -99 \n\t\t.8 1\n\t\t.8 .4\n\t\t1 .4\n\t\t1 1\n\t\t.8 1 \n  END\n\t\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('RUPESTRE', '3', '0', NULL, '  Type VECTOR\n  Filled TRUE\n  Points\n    .2 .8\n    .35 .6\n    .65 .6\n    .8 .8\n   -99 -99\n    0 .6\n    .15 .45\n    .35 .45\n    .5 .6\n    .65 .45\n    .85 .45\n    1 .6\t\t\n  END\n\t\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('CIRCLE_FILL', '3', '0', NULL, 'TYPE ELLIPSE\nFILLED TRUE\nPOINTS\n1 1\nEND\n\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('SQUARE_EMPTY', '3', '0', NULL, 'Type VECTOR\n  Points\n\t.1 .1\n\t.1 .9\n\t.9 .9\n\t.9 .1\n\t.1 .1\n  END', NULL, NULL, NULL, '0', NULL, NULL),
    ('TRIANGLE_EMPTY', '3', '0', NULL, 'Type VECTOR\n  Points\n\t.1 .1\n\t.9 .1\n\t.9 .1\n\t.5 .9\n\t.1 .1\n  END', NULL, NULL, NULL, '0', NULL, NULL),
    ('PLUS_FILL', '3', '0', NULL, 'TYPE VECTOR\nPOINTS\n    .1 .3\n    .5 .3\n    -99 -99\n    .3 .1\n    .3 .5\n    -99 -99\n    .5 .7\n    .9 .7\n    -99 -99\n    .7 .5\n    .7 .9\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('SNOW', '3', '0', NULL, 'Type VECTOR\n  Points\n\t0 .5\n\t1 .5\n\t-99 -99\n\t.2 0\n\t.8 1\n\t-99 -99\n\t.8 0\n\t.2 1\n  END\n\t\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('HEXAGON_EMPTY', '3', '0', NULL, 'Type VECTOR\n  Points\n\t.3 .1\n\t.8 .1\n\t1 .5\n\t.8 .9\n\t.3 .9\n\t.1 .5\n\t.3 .1\n  END', NULL, NULL, NULL, '0', NULL, NULL),
    ('HEXAGON_BEE', '3', '0', NULL, 'Type VECTOR\n  Points\n\t.1 0\n\t.2 .2\n\t.1 .4\n\t0 .4\n\t-99 -99\n\t.2 .2\n\t.4 .2\n\t-99 -99\n\t.5 0\n\t.4 .2\n\t.5 .4\n\t.6 .4\n  END\n', NULL, NULL, NULL, '0', NULL, NULL),
    ('ICE', '3', '0', NULL, 'Type VECTOR\n  Points\n\t0 .5\n    .5 1\n\t-99 -99\n\t0 0\n    1 .5\n\t-99 -99\n\t.5 0\n    0 1\n    -99 -99\n    .5 0\n    .5 1\n    -99 -99\n    0 0\n    0 .5\n  END\n', NULL, NULL, NULL, '0', NULL, NULL),
    ('HALF_SQUARE', '3', '0', NULL, 'Type VECTOR\n  Points\n\t.2 1.8\n\t1.8 1.8\n\t1.8 .2\n  END', NULL, NULL, NULL, '0', NULL, NULL),
    ('DASH_DASH', '3', '0', NULL, 'Type VECTOR\n  Points\n\t0 .9 \n\t.3 .9\n\t-99 -99\n\t.7 .9\n\t1 .9\n\t-99 -99\n\t.2 .4 \n\t.8 .4\n  END\n', NULL, NULL, NULL, '0', NULL, NULL),
    ('DASH_DASH_VERTICAL', '3', '0', NULL, 'Type VECTOR\n  Points\n\t.9 0 \n\t.9 .3 \n\t-99 -99\n\t.9 .7 \n\t.9 1 \n\t-99 -99\n\t.4 .2 \n\t.4 .8 \n  END\n', NULL, NULL, NULL, '0', NULL, NULL),
    ('DASH_LINE', '3', '0', NULL, 'Type VECTOR\n  Points\n\t0 .9 \n\t1 .9\n\t-99 -99\n\t.2 .4 \n\t.8 .4\n  END\n', NULL, NULL, NULL, '0', NULL, NULL),
    ('STREAMERS', '3', '0', NULL, 'Type VECTOR\n  Points\n\t.1 .1\n    .4 .1\n\t-99 -99\n\t.9 .1\n    .6 .4\n\t-99 -99\n\t.1 .6 \n    .1 .9 \n    -99 -99\n\t.4 .6\n    .7 .9\n  END\n', NULL, NULL, NULL, '0', NULL, NULL),
    ('POINT_LINE_VERTICAL', '3', '0', NULL, 'Type VECTOR\n  Points\n\t.9 0  \n\t.9 1 \n\t-99 -99\n\t .4 .4\n\t .4 .6\n  END\n', NULL, NULL, NULL, '0', NULL, NULL),
    ('DOUBLE_LINE_VERTICAL', '3', '0', NULL, 'Type VECTOR\n  Points\n    .0 0  \n\t.0 1 \n\t-99 -99\n\t.3 0  \n\t.3 1 \n\t-99 -99\n\t1 0  \n\t1 1 \n  END\n', NULL, NULL, NULL, '0', NULL, NULL),
    ('SQUARE_FILL', '3', '0', NULL, 'Type VECTOR\nFILLED TRUE\n  Points\n\t.1 .1\n\t.1 .9\n\t.9 .9\n\t.9 .1\n\t.1 .1\n  END\n\t\t', NULL, NULL, NULL, '0', NULL, NULL),
    ('RIPARIE-CANNETO', '3', '0', NULL, 'TYPE VECTOR\nPOINTS\n.3 0\n.3 1\n.7 1\nEND\n ', NULL, NULL, NULL, '0', NULL, NULL),
    ('VERTEX', '3', '0', NULL, 'TYPE VECTOR\nFILLED TRUE\nPOINTS\n\t1 8\n\t3 8\n\t3 9\n\t1 9\n\t1 8\n-99 -99\n\t7 8\n\t9 8\n\t9 9\n\t7 9\n\t7 8\n-99 -99\n\t4 1\n\t6 1\n\t6 2\n\t4 2\n\t4 1\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('T', '3', '0', NULL, 'TYPE VECTOR\nPOINTS\n.5 .5\n.5 1\t\n-99 -99\n0 .5\n1 .5\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('DOUBLE_T', '3', '0', NULL, 'TYPE VECTOR\nPOINTS\n.3 .5\n.3 1\t\n-99 -99\n.7 .5\n.7 1\t\n-99 -99\n0 .5\n1 .5\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('D', '3', '0', NULL, 'TYPE VECTOR\n FILLED TRUE\nPOINTS\n.5 0\n.5 1\n.3 .9\n.1 .7\n0 .5\n.1 .3\n.3 .1\n.5 0\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('MONUMENTO', '3', '0', NULL, 'TYPE VECTOR\nPOINTS\n.5 1\n.2 .3\n.2 .2\n.4 0\n.6 0\n.6 .2\n.6 .3\n.5 1\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('VERTICAL', '4', '0', NULL, 'TYPE VECTOR\nPOINTS\n.5 0\n.5 1\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('HORIZONTAL', '4', '0', NULL, 'TYPE VECTOR\nPOINTS\n0 .5\n1 .5\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('SQUARE_HALF', '1', '0', NULL, 'TYPE VECTOR\nFILLED TRUE\nPOINTS\n0 0\n0 1\n1 0\n0 0\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('IDRANTE', '1', '0', NULL, 'TYPE VECTOR\nFILLED TRUE\nPOINTS\n0 1\n1 1\n-99 -99\n.2 1\n.2 .4\n.8 .4\n.8 1\n.2 1\n-99 -99\n.2 .8\n0 .8\n0 .6\n.2 .6\n-99 -99\n.8 .8\n1 .8\n1 .6\n.8 .6\n-99 -99\n0 .4\n1 .4\n.9 .2\n.7 0\n.3 0\n.1 .2\n0 .4\nEND', NULL, NULL, NULL, '0', NULL, NULL),
    ('CONN.T', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#065;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('SARACINESCA', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#066;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('SALDATURA', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#067;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('RIDUTTORE', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#068;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('ALLACCIAMENTO', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#069;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('ARCO', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#070;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('VALVOLA', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#072;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('TAPPO', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#073;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('POZZETTO ISP', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#074;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('IDRANT', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#075;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('GIUNTO', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#076;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('CONTATORE', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#077;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('GENERICO', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#078;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('VUOTO', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#079;"', NULL, NULL, NULL, '0', NULL, NULL),
    ('CENTRALINA', '6', '0', NULL, 'TYPE TRUETYPE\nFONT "r3-technet"\nFILLED TRUE\nANTIALIAS FALSE\nCHARACTER "&#080;"', NULL, NULL, NULL, '0', NULL, NULL);
