...
update e_formula set formula_name = '0 Dezimalstelle' where formula_id = 1;
update e_formula set formula_name = '1 Dezimalstelle' where formula_id = 2;
update e_formula set formula_name = '2 Dezimalstellen' where formula_id = 3;
update e_formula set formula_name = '3 Dezimalstellen' where formula_id = 4;
update e_formula set formula_name = '0 Dezimalstelle (mit Tausendertrennzeichen)' where formula_id = 5;
update e_formula set formula_name = '1 Dezimalstelle (mit Tausendertrennzeichen)' where formula_id = 6;
update e_formula set formula_name = '2 Dezimalstellen (mit Tausendertrennzeichen)' where formula_id = 7;
update e_formula set formula_name = '3 Dezimalstellen (mit Tausendertrennzeichen)' where formula_id = 8;
